---
title: "What Happens to My Crypto If an Exchange Collapses?"
description: "FTX, Celsius, BlockFi — exchanges fail. When they do, your crypto may be frozen or lost. Here's how to protect yourself."
date: 2026-06-14
...
🚨 <strong>If you keep crypto on an exchange, you don't actually own it.</strong> The exchange owns it. You have an IOU. If the exchange goes bankrupt, your IOU may be worthless. Read: <a href="/safe-crypto/hot-wallets-vs-cold-wallets/">Why self-custody matters</a>
</aside>

## What Actually Happens in a Collapse

**Phase 1: Rumors (weeks before)**
Whispers on social media about financial problems. Withdrawals start slowing. The exchange says "everything is fine."

**Phase 2: The Freeze (the day of)**
The exchange halts withdrawals — "temporarily for maintenance." This is the moment your funds become inaccessible.

**Phase 3: Bankruptcy filing (days after)**
The exchange files for Chapter 11 (US) or similar. A court appoints a bankruptcy administrator. All assets are frozen.

**Phase 4: Asset recovery (months to years)**
The administrator sells remaining assets, pays lawyers and secured creditors first. Customers (unsecured creditors) get whatever is left.

**Phase 5: Payout (1-5 years later)**
Customers receive a percentage of their deposits — typically 10-60% — based on "value" at the bankruptcy date, not current prices.

## Real-World Examples

### FTX (November 2022)
- 1M+ creditors affected
- $8B+ customer funds missing
- Estimated recovery: 10-25% of claim value
- Customers locked out for over 2 years
- "Recovery" based on crypto prices from Nov 2022 (much lower than current prices)

### Celsius (July 2022)
- 600K+ creditors
- $4B+ in customer deposits frozen
- Recovery: ~30-40% in cash and stock
- No recovery of the actual crypto deposited

### BlockFi (November 2022)
- 100K+ creditors
- $1B+ frozen
- Recovery: ~40-50% initially, ongoing

### Mt. Gox (February 2014)
- 24K creditors
- 850K BTC lost (worth $450M then, $70B+ today)
- Recovery: 15-20% of BTC (years later)
- Still paying out in 2025 — 11+ years later

<aside class="callout warning">
⚠️ <strong>Notice a pattern?</strong> Every exchange collapse follows the same playbook: deny problems, freeze withdrawals, file bankruptcy, pay back pennies on the dollar years later. Don't think "it won't happen to my exchange."
</aside>
...
| Amount on Exchange | Risk Level | Recommendation |
|---|---|---|
| Under $1,000 | Low | Manageable risk |
| $1,000 - $10,000 | Medium | Should be withdrawn |
| $10,000 - $50,000 | High | Withdraw immediately |
| $50,000+ | Very High | Why is this not in cold storage? |
...
💡 <strong>The 1-hour rule:</strong> After buying crypto on an exchange, withdraw it to your wallet within 1 hour. Treat exchange balances like cash in a stranger's pocket — you want it in yours as fast as possible.
</aside>
